...
from dabox.streams.mediamtx import get_ffmpeg_commands, get_mediamtx_command
...
def main():
    cli_logo()
    mediamtx_command = get_mediamtx_command()
    ...
    processes["mediamtx"] = open_ipc_subprocess(mediamtx_command)
